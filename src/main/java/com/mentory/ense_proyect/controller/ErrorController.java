...
public class ErrorController extends ResponseEntityExceptionHandler {
    ...
    public ErrorResponse handle(HabilidadNotFoundException ex) {
        ...
        error.setType(MvcUriComponentsBuilder.fromController(ErrorController.class)
                .pathSegment("error", "habilidad-no-encontrada").build().toUri());
    ...
    public ErrorResponse handle(DuplicatedHabilidadException ex) {
        ...
        error.setType(MvcUriComponentsBuilder.fromController(ErrorController.class)
                .pathSegment("error", "habilidad-duplicada").build().toUri());
        error.setTitle("Habilidad '"+ex.getHabilidad().nombre()+"' duplicada");
    ...
    public ErrorResponse handle(LeccionNotFoundException ex) {
        ...
        error.setType(MvcUriComponentsBuilder.fromController(ErrorController.class)
                .pathSegment("error", "leccion-no-encontrada").build().toUri());
    ...
    public ErrorResponse handle(DuplicatedLeccionException ex) {
        ...
        error.setType(MvcUriComponentsBuilder.fromController(ErrorController.class)
                .pathSegment("error", "leccion-duplicada").build().toUri());
        error.setTitle("Lección '"+ex.getLeccion().getId()+"' duplicada");
    ...
    public ErrorResponse handle(DuplicatedModuloException ex) {
        ...
        error.setTitle("Módulo '"+ex.getModulo().getId()+"' duplicado");
    ...
    public ErrorResponse handle(DuplicatedSuscripcionException ex) {
        ...
        error.setTitle("Suscripción '"+ex.getSuscripcion().getId()+"' duplicada");
    ...
    public ErrorResponse handle(DuplicatedUsuarioException ex) {
        ...
        error.setTitle("Usuario '"+ex.getUsuario().getUsername()+"' duplicado");
